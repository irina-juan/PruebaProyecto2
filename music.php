...
<html lang="en" dir="ltr">
  ...
  <div class="container">
      ...
      <p><a class="btn btn-secondary" href="rock.php" role="button">View details »</a></p>
         </div>
         ...
         <div class="col-md-4">
                ...
                <p> Grandes Compositores de musica academica</p>
                 <p><a class="btn btn-secondary" href="clasica.php" role="button">View details »</a></p>
          </div>
      </div>
  </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                  ...
                  <p><a class="btn btn-secondary" href="electronica.php" role="button">View details »</a></p>
            </div>
          ...
          <div class="col-md-4">
                ...
                <img class="producto" src="./imagenes/catgmusic/hiphop.jpg" alt="hiphop">
                  ...
                  <p><a class="btn btn-secondary" href="hip.php" role="button">View details »</a></p>
           </div>
           ...
           <div class="col-md-4">
                  ...
                  <p><a class="btn btn-secondary" href="pop.php" role="button">View details »</a></p>
            </div>
        </div>
      </div>
    <hr class="featurette-divider">
    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p><a class="btn btn-secondary" href="reggue.php" role="button">View details »</a></p>
           </div>
           ...
           <div class="col-md-4">
             ...
             <p>El jazz rompe barreras y crea oportunidades para la comprensión y la tolerancia mutua</p>
               <p><a class="btn btn-secondary" href="jazz.php" role="button">View details »</a></p>
            </div>
        </div>
      </div>
